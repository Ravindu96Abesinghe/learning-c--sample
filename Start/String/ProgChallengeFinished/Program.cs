...
// Keep track of the number og guesses and the current user guess
int guessNum = 0;
int guessCount = 0;
...
do {
    ...
    // If the user enterd something other than a number ask them again
    if (!result) {
        ...
        if (guessNum == -1) {
            ...
            if (guessNum == theNumber) {
                ...
                //Tell them to either guess lower or higher than the prrevious guess
