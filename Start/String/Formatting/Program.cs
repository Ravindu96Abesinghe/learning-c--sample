...
string str1 = "TestStr";
int val1 = 1234;
decimal var2 = 1234.5678m;

// Basic Formating information
Console.WriteLine("{0}", str1);

// TODO: Specifying Numerical formatting
// Genenal format is {index[,alignment]:[format]}
...
Console.WriteLine("{0:E}, {0:N}, {0:F}, {0:G}", var2);
...
Console.WriteLine("{0,12:P0}, {1,12:P0}, {2,12:P0}, {3,12:P0}"
